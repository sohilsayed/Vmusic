...
object DatabaseModule {
    ...
    @Provides fun provideDownloadedItemDao(db: AppDatabase): DownloadedItemDao = db.downloadedItemDao()
    ...
    @Provides fun providePersistedPlaybackStateDao(db: AppDatabase): PersistedPlaybackStateDao = db.persistedPlaybackStateDao()
